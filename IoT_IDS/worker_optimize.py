    ...
    def run(self):
        ...
        for EPOCH in range(EPOCHS + 1):
            ...
            if subject == "model":
                ...
                if EPOCH < EPOCHS:
                    _, _, train_data_loader = DataPreprocessing(datatrain, 200000*(EPOCH+1), BATCH_SIZE)
...
# datatest = ReadDataFromCSV('./Datasets/N_BaIoT/5.benign.csv', './Datasets/N_BaIoT/5.gafgyt.combo.csv', './Datasets/N_BaIoT/5.gafgyt.junk.csv', './Datasets/N_BaIoT/5.gafgyt.scan.csv', './Datasets/N_BaIoT/5.gafgyt.udp.csv', './Datasets/N_BaIoT/5.mirai.ack.csv', './Datasets/N_BaIoT/5.mirai.scan.csv', './Datasets/N_BaIoT/5.mirai.syn.csv', './Datasets/N_BaIoT/5.mirai.udp.csv', './Datasets/N_BaIoT/5.mirai.udpplain.csv', isTest = True)
...
X_test, y_test, test_data_loader = DataPreprocessing(datatest, 200000, 200)
